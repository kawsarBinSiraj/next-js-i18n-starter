...
export function LoginForm() {
    ...
    const loginSchema = yup.object({
        ...
        password: yup.string().min(1, t("validation.passwordRequired")).required(t("validation.passwordRequired")),
    });
            ...
            <CardHeader className="space-y-3 pb-3">
                <div className="flex items-center gap-2">
                    <Button
                        ...
                        variant="outline"
                        size="icon-sm"
                        className="rounded-full border-slate-200 bg-white/70 dark:border-slate-700 dark:bg-slate-900/70"
                    >
                ...
                <CardContent className="flex flex-col gap-5">
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex items-center justify-between">
                            ...
                            <Link
                                href="/forgot"
                                className="text-xs font-medium text-slate-500 underline-offset-4 hover:text-slate-800 hover:underline dark:text-slate-300 dark:hover:text-slate-100"
                            >
