...
export function VerifyForm() {
    ...
    const verifySchema = yup.object({
        code: yup
            .string()
            .matches(/^\d{6}$/, t("validation.codeInvalid"))
        ...
        return (
            <Card className="mx-auto w-full max-w-md rounded-3xl border-white/50 bg-white/85 shadow-2xl shadow-amber-950/10 backdrop-blur-md dark:border-white/10 dark:bg-slate-950/65 dark:shadow-black/40">
                <CardHeader className="space-y-3">
                    ...
                    <CardTitle className="text-3xl tracking-tight">{t("verify.success.title")}</CardTitle>
                ...
                <CardFooter>
                    <Button asChild className="h-11 w-full rounded-xl text-sm font-semibold">
                        <Link href="/login">{t("verify.success.backToLogin")}</Link>
                    </Button>
                </CardFooter>
            </Card>
        );
    ...
    return (
        <Card className="mx-auto w-full max-w-md rounded-3xl border-white/50 bg-white/85 shadow-2xl shadow-amber-950/10 backdrop-blur-md dark:border-white/10 dark:bg-slate-950/65 dark:shadow-black/40">
            ...
            <CardHeader className="space-y-3 pb-3">
                ...
                <CardTitle className="text-3xl tracking-tight">{t("verify.title")}</CardTitle>
                <CardDescription className="text-sm text-slate-600 dark:text-slate-300">
